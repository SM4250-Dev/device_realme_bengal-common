...
$(call inherit-product, vendor/realme/bengal-common/bengal-common-vendor.mk)
...
PRODUCT_COPY_FILES += \
    ...
    $(AUDIO_HAL_DIR)/configs/bengal/audio_tuning_mixer.txt:$(TARGET_COPY_OUT_VENDOR)/etc/audio_tuning_mixer.txt \
